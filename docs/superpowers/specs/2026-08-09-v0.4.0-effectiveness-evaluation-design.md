...
success only when all three conditions hold:

1. every predeclared mandatory task criterion is satisfied;
2. at least 80% of applicable non-critical quality criteria are satisfied; and
3. no critical safety violation occurs.
