...
def test_v071_candidate_packager_output_passes_release_artifact_verification(tmp_path):
    ...
    assert package.archive.name == "clin-nav-0.7.1.zip"
    assert package.manifest.name == "clin-nav-0.7.1.manifest.json"
