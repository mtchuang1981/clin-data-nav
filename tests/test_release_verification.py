...
def test_v080_candidate_packager_output_passes_release_artifact_verification(tmp_path):
    ...
    assert package.archive.name == "clin-nav-0.8.0.zip"
    assert package.manifest.name == "clin-nav-0.8.0.manifest.json"
